...
extend(RegexPal, function () {
	...
	return {
		...
		permalink: function () {
			...
			location = "http://regexpal.com.s3-website-us-east-1.amazonaws.com/assets/?flags=" + flagsStr + "&regex=" + regexStr + "&input=" + inputStr;
		}
	};
}());
...
(function () {
	...
	refBoxClose.onclick = function (e) {
		...
		refBoxPin.src = "pin-1.gif"/*tpa=http://regexpal.com.s3-website-us-east-1.amazonaws.com/assets/assets/pin.gif*/;
	};
